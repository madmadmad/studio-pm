...
export default function TeamMemberDashboard({ projects, weekHours }) {
    return (
        <AppLayout>
            ...
            <p className="text-sm text-sage mb-6">Your projects and hours this week.</p>
            ...
            <h2 className="text-sm font-semibold mb-3 text-sage">Your projects</h2>
                    ...
                    projects.map((project) => (
                        ...
                        >
                            <div>
                                ...
                                <div className="text-xs text-sage">{project.company.name}</div>
                            </div>
